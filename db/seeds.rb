...
image = Base64.encode64(File.open(File.join(Rails.root, "/app/assets/images/roundflower.jpg")).read)
...
Post.create(image: image, description: post_description, amount_expected: amount)
